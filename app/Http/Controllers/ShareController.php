...
class ShareController extends Controller
{
     ...
     */
    public function share($agent,$unionid='')
    {
        $key=$agent.time().rand(10000,99999);
        //代理ID  645546sdf23sdfsda=>6  库4
        Redis::set($key,json_encode(['agent'=>$agent]));
        //https://uc.psz.suit.wang/api/v1/thirdauth/webauth?callback=http://psz.partner.suit.wang/share/callback?state=645546sdf23sdfsda
